...
namespace UE_Server.Entities
{
    public static class PlayerKeyHandler
    {
        ...
        {
            GameMode.RegisterEventHandler("OnKeyPress", new Action<Player, dynamic>(OnKeyPress));
        }

        public static void OnKeyPress([FromSource] Player player, dynamic control)
        {
            Logger.Info("loot: " + player.GetSteamID());
            /*
            switch (control)
            {
                case Control.Loot:
