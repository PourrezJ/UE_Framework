...
namespace UE_Shared.MenuManager
{
    public class Menu
    {
        ...
        public delegate Task MenuCallbackAsync(Player client, Menu menu, IMenuItem menuItem, int itemIndex);
        public delegate Task MenuCheckboxAsync(Player client, Menu menu, IMenuItem menuItem, bool value);
        public delegate Task MenuListCallbackAsync(Player client, Menu menu, IListItem listItem, int listIndex);
        public delegate Task MenuCurrentIndexAsync(Player client, Menu menu, int itemIndex, IMenuItem menuItem);
        public delegate Task MenuFinalizerAsync(Player client, Menu menu);
